# SEO Audit Performer (OpenClaw Skill)

**Build better OpenClaw bots, faster.**

Runs technical SEO checks and prioritizes fixes by impact.
...
- Run focused automation workflows around **SEO Audit Performer**
...
```bash
# Clone
git clone https://github.com/mogus-prog/seo-audit-performer-skill.git
cd seo-audit-performer-skill
